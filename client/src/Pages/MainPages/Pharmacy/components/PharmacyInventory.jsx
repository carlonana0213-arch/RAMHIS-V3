          ...
          >
            ...
            <div className="border-b border-border-soft px-5 py-5 sm:px-6">
              ...
              <div className="mt-5 flex w-full flex-col gap-3 lg:flex-row lg:items-center">
                ...
                <div className="flex shrink-0 items-center rounded-xl border border-border-soft bg-surface-muted p-1">
              ...
              <div className="flex min-h-[320px] flex-col items-center justify-center px-6 text-center">
                ...
                <p className="mt-2 max-w-sm text-sm leading-6 text-text-muted">
                  ...
                  {searchTerm ? (
                    ...
                    "There are no medicines in this stock category."
                  )}
                ...
                <button
                  ...
                  className="mt-4 rounded-xl px-4 py-2 text-xs font-semibold text-primary-700 transition hover:bg-primary-50 hover:text-primary-900"
                >
                  Clear Search & Filter
                </button>
                                ...
                                <div className="min-w-0">
                                  ...
                                  {isOutOfStock ? (
                                    ...
                                    <div className="mt-1 flex items-center gap-1.5">
                                      ...
                                      <span className="h-1.5 w-1.5 rounded-full bg-status-critical-dot" />

                                      <span className="text-[11px] font-medium text-status-critical-text">
                                        Out of stock
                                      </span>
