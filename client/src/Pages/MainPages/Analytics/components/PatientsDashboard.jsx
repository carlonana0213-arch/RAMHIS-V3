  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h2 className="mt-3 text-xl font-extrabold tracking-tight text-text-primary">
          Patient Overview
        </h2>
...
function AnalyticsStatCard({
  ...
  return (
    <div className="rounded-2xl border border-border bg-surface p-5 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:shadow-md">
