      ...
      <div className="min-h-full bg-slate-50 p-6 lg:p-8">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-2xl border border-red-200 bg-surface p-8 text-center shadow-sm">
            ...
            <button
              onClick={loadUser}
              className="mt-5 rounded-xl bg-primary-700 px-5 py-3 text-sm font-semibold text-white transition hover:bg-primary-800"
            >
              Try Again
            </button>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[300px_minmax(0,1fr)]">
          ...
          <div className="rounded-2xl border border-border bg-surface p-6 shadow-sm">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex h-24 w-24 items-center justify-center rounded-2xl bg-primary-700 text-3xl font-extrabold text-white shadow-lg shadow-blue-700/20">
                {getInitial()}
              </div>
          ...
          <div className="rounded-2xl border border-border bg-surface shadow-sm">
            ...
            <div className="p-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-border-strong bg-surface py-3 pl-11 pr-4 text-sm font-medium text-text-primary outline-none transition focus:border-blue-600 focus:ring-4 focus:ring-blue-100"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={getRoleLabel()}
                      disabled
                      className="w-full cursor-not-allowed rounded-xl border border-border bg-slate-50 py-3 pl-11 pr-4 text-sm font-medium text-text-muted"
                    />
                  </div>
                </div>
              ...
              <div className="mt-6 rounded-xl border border-blue-100 bg-primary-50/60 p-4">
              ...
              <div className="mt-6 flex flex-col-reverse gap-3 border-t border-border-soft pt-5 sm:flex-row sm:justify-end">

                <button
                  type="button"
                  onClick={handleCancel}
                  disabled={saving}
                  className="inline-flex items-center justify-center gap-2 rounded-xl border border-border-strong bg-surface px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <X size={17} />
                  Cancel
                </button>
                ...
                <button
                  ...
                  onClick={handleSave}
                  disabled={saving}
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary-700 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-primary-800 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {saving ? (
                    <>
          ...
          <div className="flex flex-col gap-5 p-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="mt-3 flex items-center gap-2 text-xs font-medium text-text-subtle">
                  <LockKeyhole size={14} />
            ...
            <button
              ...
              className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl border border-border-strong bg-surface px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-blue-300 hover:bg-primary-50 hover:text-primary-700"
            >
              <KeyRound size={17} />
              Change Password
            </button>
          ...
          >
            ...
            <div className="flex items-start justify-between border-b border-border px-6 py-5">
              ...
              <button
                type="button"
                onClick={closePasswordModal}
                className="rounded-lg p-2 text-text-subtle transition hover:bg-slate-100 hover:text-slate-700"
              >
                <X size={19} />
              </button>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-border-strong py-3 pl-11 pr-12 text-sm text-text-primary outline-none transition focus:border-blue-600 focus:ring-4 focus:ring-blue-100"
                  />
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1.5 text-text-subtle hover:bg-slate-100 hover:text-slate-700"
                  >
                    {showPassword ? (
                      <EyeOff size={18} />
                    ) : (
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-border bg-slate-50 px-6 py-4 sm:flex-row sm:justify-end">
              ...
              <button
                ...
                onClick={closePasswordModal}
                disabled={saving}
                className="rounded-xl border border-border-strong bg-surface px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:opacity-50"
              >
                Cancel
              </button>
              ...
              <button
                ...
                disabled={saving}
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary-700 px-5 py-3 text-sm font-semibold text-white transition hover:bg-primary-800 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {saving ? (
                  <>
                    <span className="h-4 w-4 animate-spin rounded-full border-2 border-white/30 border-t-white" />
