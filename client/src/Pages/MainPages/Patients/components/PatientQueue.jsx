      ...
      <div className="animate-pulse">
        ...
        {Array.from({ length: 8 }).map(
          (_, index) => (
            <div
              key={index}
              className="grid grid-cols-7 gap-4 border-t border-slate-100 px-5 py-4"
            >
              {Array.from({
                length: 7,
              }).map((__, cell) => (
    ...
    <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="overflow-x-auto">
        ...
        <div className="min-w-[1000px]">
          ...
          {/* TABLE HEADER */}
          <div className="grid grid-cols-[60px_2fr_80px_90px_1.2fr_140px_100px] items-center bg-slate-50 px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-slate-400">
            ...
            patients.map(
              (patient, index) => {
                ...
                return (
                  <div
                    key={patient._id}
                    className="grid grid-cols-[60px_2fr_80px_90px_1.2fr_140px_100px] items-center border-t border-slate-100 px-5 py-4 transition hover:bg-blue-50/40"
                  >
                    ...
                    <button
                      ...
                      className="inline-flex w-fit items-center justify-center rounded-lg bg-blue-50 px-3 py-2 text-xs font-bold text-blue-600 transition hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-4 focus:ring-blue-100"
                    >
                      View
                    </button>
