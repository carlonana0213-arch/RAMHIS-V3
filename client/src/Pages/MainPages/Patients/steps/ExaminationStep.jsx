          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                value={exam.bmi || ""}
                readOnly
                className="w-full rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 text-sm font-bold text-blue-800 outline-none"
              />

              <span className="shrink-0 rounded-lg bg-slate-100 px-3 py-2 text-xs font-semibold text-slate-500">
                BMI
              </span>
            </div>
          </div>
