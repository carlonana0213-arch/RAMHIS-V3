  ...
  if (!patient) {
    return (
      <section className="flex min-h-[360px] flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm">
        ...
        <p className="mt-1 max-w-[220px] text-sm font-medium leading-6 text-slate-500">
      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 break-words text-xl font-extrabold tracking-tight text-slate-900">
              {name}
            </h2>
          </div>
        ...
        <div className="mt-auto grid grid-cols-2 gap-2 pt-5">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-xs font-extrabold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-sky-400/10 active:scale-[0.98]"
          >
            Next
            <ArrowRight size={15} />
          </button>
