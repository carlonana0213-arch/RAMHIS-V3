...
import ramhisBanner from "../../assets/images/ramhis-trans-banner.png";

export default function Home() {
  return (
    <LandingLayout>
      <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700 pt-32">
        {/* RAMHIS Background Image */}
        <div
          className="pointer-events-none absolute inset-0 bg-right-center bg-no-repeat opacity-80"
          style={{
            backgroundImage: `url(${ramhisBanner})`,
            backgroundSize: "cover",
          }}
        />

        {/* Blue Overlay */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-blue-950/90 via-blue-900/60 to-blue-800/30" />

        {/* Hero Content */}
        <div className="relative z-10 mx-auto flex min-h-[80vh] max-w-7xl items-center px-6 py-20 lg:px-10">
